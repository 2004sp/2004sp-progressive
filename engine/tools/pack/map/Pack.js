...
export async function packMaps(cache, modelFlags) {
    ...
    for (const name of maps) {
        ...
        const needsRebuild =
            packerUpdated ||
            shouldBuildFile(file, mapFile) ||
            shouldBuildFile(file, locFile) ||
            shouldBuildFile(file, serverMapFile) ||
            shouldBuildFile(file, serverLocFile) ||
            shouldBuildFile(file, serverNpcFile) ||
            shouldBuildFile(file, serverObjFile);
