...
import SetClanStateEncoder from '#/network/game/server/codec/SetClanStateEncoder.js';
...
import PNameDialogEncoder from '#/network/game/server/codec/PNameDialogEncoder.js';
...
class ServerGameProtRepository {
    ...
    constructor() {
        ...
        this.bind(MessageClan, new MessageClanEncoder());
        this.bind(SetClanState, new SetClanStateEncoder());
        ...
        this.bind(PNameDialog, new PNameDialogEncoder());
